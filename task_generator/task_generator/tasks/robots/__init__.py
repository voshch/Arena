...
from . import characterization, demo, explore, guided, patrol, random, scenario, stationary
...
__all__ = ["TM_Robots", "characterization", "demo", "explore", "guided", "patrol", "random", "scenario", "stationary"]
