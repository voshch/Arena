...
def test_sound_event_round_trips_to_heard_sound_event(rclpy_context):
    ...
    from arena_auditory.acoustic_frame import runtime_acoustic_offset
    from arena_auditory.qos_profiles import transient_event_qos
...
def test_spawn_microphone_assigns_zone_and_next_index(rclpy_context):
    ...
    from arena_auditory.acoustic_scene import (
        AcousticScene,
        AcousticZone,
    )
    from arena_auditory.microphone_config import WorldMicrophoneSpec
    from arena_auditory.sound_propagation_node import (
        SoundPropagationNode,
    )
...
def test_four_mic_array_renders_and_fuses_robot_hearing_event(rclpy_context):
    ...
    from arena_auditory.microphone_array_node import MicrophoneArrayNode
    from arena_auditory.qos_profiles import transient_event_qos
    from arena_auditory.robot_hearing_node import RobotHearingNode
    from task_generator_msgs.msg import HeardSoundEvent
...
def test_auditory_round_trip_greeting_reaches_robot_marker(rclpy_context):
    ...
    from arena_auditory.qos_profiles import acoustic_metadata_qos, transient_event_qos
    from arena_auditory.robot_hearing_node import RobotHearingNode
    from arena_auditory.sound_propagation_node import SoundPropagationNode
...
def test_motor_sound_publishes_cone_and_clears_it(rclpy_context):
    ...
    from rclpy.parameter import Parameter
    from arena_auditory.qos_profiles import transient_event_qos
    from arena_auditory.robot_sound_node import RobotSoundNode
...
def test_human_sound_node_publishes_footstep_and_cone(rclpy_context):
    ...
    from arena_people_msgs.msg import Pedestrians
    from rclpy.parameter import Parameter
    from arena_auditory.human_sound_node import HumanSoundNode
    from arena_auditory.qos_profiles import transient_event_qos
    from task_generator_msgs.msg import SoundEvent
    from visualization_msgs.msg import Marker, MarkerArray
...
def test_human_sound_detector_uses_pose_when_twist_is_zero():
    from arena_people_msgs.msg import Pedestrians
    from arena_auditory.auditory_events import (
...
def test_propagation_visualizer_splits_pedestrian_and_robot_markers(
    ...
    import rclpy
    from rclpy.parameter import Parameter
    from arena_auditory.sound_propagation_visualizer import (
