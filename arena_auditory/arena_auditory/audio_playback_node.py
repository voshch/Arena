...
from arena_auditory.audio_mixer import AudioMixer
...
class SoundPlaybackNode(Node):
    def __init__(
        ...
        **kwargs: object,
        ...
        self._material_catalog = AcousticMaterialCatalog(share_dir / "config" / "acoustic_materials.yaml")
        ...
        if self._use_rir:
            materials = AcousticMaterialCatalog(share_dir / "config" / "acoustic_materials.yaml")
